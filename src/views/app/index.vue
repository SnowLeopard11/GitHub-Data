  ...
  <div class="app-page">
    ...
    <div class="tm-content col-md-6 col-sm-8 col-xs-12 ml-auto section">
      <div class="content-box">
          ...
          <header class="mb-5"><h1>GitHub Data</h1></header>
              ...
              <div class="col-sm-8 col-xs-10">
                ...
                <!-- 服务条款 -->
                  <div class="help-content">
                      ...
                      <strong v-if="nousename">{{ $t("app.account") }} :
                          <a>{{ errname }}</a>
                          {{ $t("app.notFound") }}
                      </strong>
                      <p v-else>
                          {{ $t("app.clickP") }}<button @click="showpm">{{ $t("app.clickB") }}</button>
                      </p>
                  </div>
                <!-- 生成按钮 -->
                  <div class="col-sm-4 col-xs-5">
                      <button class="tm-btn-subscribe" @click="generate(username)">{{ $t("app.subscribe") }}</button>
                  </div>
              </div>
            </div>
          </div>
